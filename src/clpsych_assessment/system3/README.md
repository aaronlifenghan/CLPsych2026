...
```bash
# Single timeline
uv run python -m clpsych_assessment.system3.run_task_1_1 data/train_tasks12/0cac13e357.json
uv run python -m clpsych_assessment.system3.run_task_1_2 data/train_tasks12/0cac13e357.json
uv run python -m clpsych_assessment.system3.run_task_2   data/train_tasks12/0cac13e357.json

# Entire dataset directory
uv run python -m clpsych_assessment.system3.run_task_1_1 data/test_tasks12nolabels/ --output results_1_1.json
uv run python -m clpsych_assessment.system3.run_task_1_2 data/test_tasks12nolabels/ --output results_1_2.json
uv run python -m clpsych_assessment.system3.run_task_2   data/test_tasks12nolabels/ --output results_2.json
```
